    ...
    def select_unassigned_variable(self, assignment):
        ...
        for var in self.crossword.variables - set(assignment):
            if currentBest is None:
                currentBest = var
            elif len(self.domains[var]) < len(self.domains[currentBest]):
                currentBest = var
            elif len(self.crossword.neighbors(var)) > len(self.crossword.neighbors(currentBest)):
                currentBest = var
