...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            ...
            elif old != sentence and old.cells <= sentence.cells:
                cells = sentence.cells - old.cells
                count = sentence.count - old.count
    ...
    def make_safe_move(self):
        ...
        """
        safe = self.safes.copy()
        safe -= self.moves_made
